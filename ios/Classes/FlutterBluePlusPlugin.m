...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result
{
    @try
    {
        ...
        {
            CBUUID *customServiceUuid = [CBUUID UUIDWithString:@"2D1CDE29-110C-903D-BF3F-A82F0D73F67D"];

            NSArray *periphs = [self.centralManager retrieveConnectedPeripheralsWithServices:@[customServiceUuid]];
